...
// import 'package:madaduser/feature/auth/view/update_profile_screen.dart';
// import 'package:madaduser/feature/booking/view/repeat_booking_details_screen.dart';
// import 'package:madaduser/feature/checkout/view/offline_payment_screen.dart';
// import 'package:madaduser/feature/provider/view/nearby_provider/near_by_provider_screen.dart';
// import 'package:madaduser/utils/core_export.dart';
// import 'package:madaduser/feature/vehicle/vehicle/view/vehicle_binding.dart';
...
// import '../feature/TypesofCarwash/TypesOfCarWash_screen.dart';
//
// class RouteHelper {
...
//   static const String vehicleSelectView = '/VehicleSelectView';
...
//   }
//
//   static String getAccessLocationRoute(String page, {String? route}) =>
//       '$accessLocation?page=$page${route != null ? '&route=$route' : ''}';
//
...
//   }
//
//   static String getVehicleSelectViewRoute({
//     required String serviceId,
//     required String subCategoryId,
//     required String categoryId,
//   }) {
//     return '$vehicleSelectView?serviceId=$serviceId&subCategoryId=$subCategoryId&categoryId=$categoryId';
//   }
//
...
//   static String getVehicleModelScreen() => vehicle;
...
//   static String getProviderDetails(String providerId) => '$providerDetailsScreen?id=$providerId';
//   static String getProviderReviewScreen(String providerId) => '$providerReviewScreen?id=$providerId';
//   static String getProviderAvailabilityScreen(String providerId) => '$providerAvailabilityScreen?provider_id=$providerId';
...
//     GetPage(
//       name: '/typesOfCarWash',
//       page: () => TypesOfCarWashView(
//         categoryId: Get.parameters['categoryId'] ?? '',
//       ),
//       binding: BindingsBuilder(() {
//         Get.lazyPut<TypesOfCarWashController>(() => TypesOfCarWashController());
//       }),
//     ),
//
//     GetPage(
...
//           firebaseSession: Get.parameters['session'] == 'null' ? null : utf8.decode(base64Url.decode(Get.parameters['session'] ?? '')),
//         );
//       },
//     ),
//     GetPage(
...
//         return NewPassScreen(forgetPasswordBody: forgetPasswordBody);
//       },
//     ),
//     GetPage(
//       name: featheredServiceScreen,
//       page: () => AllFeatheredCategoryServiceView(
//         fromPage: Get.parameters['fromPage'],
//         categoryId: Get.parameters['categoryId'],
//       ),
//     ),
...
//       page: () => getRoute(Get.arguments ?? ServiceDetailsScreen(serviceID: Get.parameters['id'], fromPage: Get.parameters['fromPage'])),
//     ),
...
//       page: () => getRoute(CategorySubCategoryScreen(
...
//       page: () => getRoute(AllServiceView(fromPage: Get.parameters['fromPage'], campaignID: Get.parameters['campaignID'])),
//     ),
//     GetPage(
//       binding: ServiceBinding(),
...
//       page: () => RateReviewScreen(id: Get.parameters['id']),
//     ),
...
//       name: myWallet,
//       page: () => WalletScreen(status: Get.parameters['flag'], token: Get.parameters['token'], fromNotification: Get.parameters['fromNotification']),
//     ),
//     GetPage(
//       binding: LoyaltyPointBinding(),
//       name: loyaltyPoint,
//       page: () => LoyaltyPointScreen(fromNotification: Get.parameters['fromNotification']),
//     ),
...
//       page: () => getRoute(ProviderAvailabilityWidget(providerId: Get.parameters['provider_id']!)),
//     ),
...
//     GetPage(name: myPost, page: () => AllPostScreen(fromNotification: Get.parameters["fromNotification"])),
//     GetPage(
...
//     GetPage(name: nearByProvider, page: () => NearByProviderScreen(tabIndex: int.tryParse(Get.parameters['tabIndex'] ?? "0") ?? 0)),
//     GetPage(
...
//       ),
//     ),
//     GetPage(name: favorite, page: () => const MyFavoriteScreen()),
...
class RouteHelper {
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
      name: bookingListScreen, // which is '/booking-list'
  ...
  static Widget getRoute(Widget navigateTo) {
    String normalize(String route) {
      return route.split('?')[0].replaceAll(RegExp(r'/$'), '');
    }

    String currentRoute = normalize(Get.currentRoute);

    bool isRouteExist = currentRoute == "/" || routes.any((route) {
      String routeName = normalize(route.name ?? '');
      return currentRoute == routeName;
    });

    bool isUserAuthenticated = _checkUserAuthentication();

    if (!isRouteExist) {
      debugPrint(" Route not found: ${Get.currentRoute}");
      debugPrint(" Normalized route: $currentRoute");
      debugPrint(" User authenticated: $isUserAuthenticated");
      debugPrint(" Available routes: ${routes.map((r) => r.name).toList()}");
    }
    ...
    bool hasLocation = Get.find<LocationController>().getUserAddress() != null;

    if (!isRouteExist && isUserAuthenticated) {
      debugPrint(" Authenticated user accessing invalid route, redirecting to home");
      Future.microtask(() {
        Get.offAllNamed(RouteHelper.getMainRoute('home'));
      });
      AddressModel? addressData;
      try {
        addressData = Get.find<LocationController>().getUserAddress();
      } catch (e) {
        debugPrint("Error getting user address: $e");
      }
      return const BottomNavScreen(pageIndex: 0, previousAddress: null, showServiceNotAvailableDialog: false);
    }
  ...
  static bool _checkUserAuthentication() {
    try {
      ...
      debugPrint("Error checking authentication in RouteHelper: $e");
      return false;
    }
  }
