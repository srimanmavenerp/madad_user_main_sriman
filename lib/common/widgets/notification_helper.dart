...
import 'package:madaduser/common/widgets/demo_reset_dialog_widget.dart';
import 'package:madaduser/customsnackbar.dart';
import 'package:madaduser/feature/booking/widget/booking_ignored_bottom_sheet.dart';
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      ...
      if(!ResponsiveHelper.isWeb()){
        if(message.data['type']=='bidding'){
          ...
          Get.offNamed(RouteHelper.getSignInRoute());
showCustomSnackbar(
  title: message.data['title'] ?? 'Info',
  message: message.data['body'] ?? '', // optional body if available
  type: SnackbarType.info, // defaulting to info
  ...
  static Future<void> showTextNotification(String title, String? body, String orderID, FlutterLocalNotificationsPlugin fln) async {
    const AndroidNotificationDetails androidPlatformChannelSpecifics = AndroidNotificationDetails(
      'madaduser', 'madaduser', playSound: true,
  ...
  static Future<void> showBigTextNotification(String title, String? body, String payload, String image, FlutterLocalNotificationsPlugin fln) async {
    ...
    if(!Get.find<AuthController>().isNotificationActive()){
      AndroidNotificationDetails androidPlatformChannelSpecifics = AndroidNotificationDetails(
        "madaduserWithoutsound","madaduser without sound", channelDescription:"description",
        playSound: false,
      ...
      AndroidNotificationDetails androidPlatformChannelSpecifics = AndroidNotificationDetails(
        "madaduser", 'madaduser with sound', channelDescription:"description",
        playSound: true,
