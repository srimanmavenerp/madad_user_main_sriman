...
class ConfigContent {
  ...
  ConfigContent.fromJson(Map<String, dynamic> json) {
    ...
    providerSelfRegistration = int.tryParse(json['provider_self_registration']?.toString() ?? '0');
    ...
    phoneVerification = int.tryParse(json['phone_verification']?.toString() ?? '0');
    emailVerification = int.tryParse(json['email_verification']?.toString() ?? '0');
    firebaseOtpVerification = int.tryParse(json['firebase_otp_verification']?.toString() ?? '0');
    ...
    minBookingAmount = double.tryParse(json['min_booking_amount']?.toString() ?? '0');
    maxBookingAmount = double.tryParse(json['max_booking_amount']?.toString() ?? '0');
    guestCheckout = int.tryParse(json['guest_checkout']?.toString() ?? '0');
    offlinePayment = int.tryParse(json['offline_payment']?.toString() ?? '0');
    partialPayment = int.tryParse(json['partial_payment']?.toString() ?? '0');
    additionalChargeLabelName = json['additional_charge_label_name'];
    additionalChargeFeeAmount = double.tryParse(json['additional_charge_fee_amount']?.toString() ?? '0');
    additionalCharge = int.tryParse(json['booking_additional_charge']?.toString() ?? '0');
    ...
    instantBooking = int.tryParse(json['instant_booking']?.toString() ?? '0');
    scheduleBooking = int.tryParse(json['schedule_booking']?.toString() ?? '0');
    scheduleBookingTimeRestriction = int.tryParse(json['schedule_booking_time_restriction']?.toString() ?? '0');
    ...
    customerLogin = json['login_setup'] != null ? CustomerLogin.fromJson(json['login_setup']) : null;
    ...
    repeatBooking = int.tryParse(json['repeat_booking']?.toString() ?? '0');
    createGuestUserAccount = int.tryParse(json['create_user_account_from_guest_info']?.toString() ?? '0');
    serviceAtProviderLocation = int.tryParse(json['service_at_provider_place']?.toString() ?? '0');
    newsletterTitle = (json['newsletter_title'] != null && json['newsletter_title'] != "") ? json['newsletter_title'] : null;
    newsletterDescription = (json['newsletter_description'] != null && json['newsletter_description'] != "") ? json['newsletter_description'] : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['forget_password_verification_method'] = forgetPasswordVerificationMethod?.toJson();
