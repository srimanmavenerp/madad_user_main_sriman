...
import 'package:madaduser/feature/booking/widget/repeat/repeat_booking_details_widget.dart';
import 'package:madaduser/feature/booking/widget/repeat/repeat_booking_service_log_widget.dart';
      ...
      return Container(
        ...
        child: DecoratedBox(
          decoration: BoxDecoration(
            ...
            border: Border(bottom: BorderSide(color: Colors.deepPurple, width: 0.5),),
          ),
          child: Row(
            children: [
              Expanded(
