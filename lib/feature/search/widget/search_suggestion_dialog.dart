...
import 'package:madaduser/feature/search/widget/realtime_search_suggestion.dart';
import 'package:madaduser/feature/search/widget/recommended_search.dart';
    ...
    return GetBuilder<AllSearchController>(builder: (searchController){
      return Container(
        ...
        child: Column( mainAxisSize: MainAxisSize.min, children: [
          ...
          ResponsiveHelper.isDesktop(context) ? const WebMenuBar(openSearchDialog: false,) :
