...
showCustomSnackbar(
  title: 'Error',
  message: response.body["message"]?.toString().capitalizeFirst ?? response.statusText ?? 'Something went wrong',
  type: SnackbarType.error,
);
  ...
  showCustomSnackbar(
    title: 'Info',
    message: 'please_submit_a_valid_phone_number'.tr,
    type: SnackbarType.info,
  );
} else {
  showCustomSnackbar(
    title: 'Error',
    message: '${e.message}'.replaceAll('_', ' ').capitalizeFirst!,
    type: SnackbarType.error,
  );
}
  ...
  type: SnackbarType.success,
    ...
    showCustomSnackbar(
  title: 'Info',
  message: responseModel.message.toString().capitalizeFirst!,
  type: SnackbarType.info,
);
