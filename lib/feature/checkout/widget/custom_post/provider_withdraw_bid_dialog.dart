      ...
      child: Container(
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, mainAxisSize: MainAxisSize.min, children: [
          ...
          InkWell(
            ...
            child: Text("view_other_offers".tr, style: robotoMedium.copyWith( fontSize: Dimensions.fontSizeDefault, color:  Get.isDarkMode? Theme.of(context).hintColor : Colors.deepPurple, decoration : TextDecoration.underline)),
          ),
