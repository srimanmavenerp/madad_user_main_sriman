          ...
          child: GetBuilder<LoyaltyPointController>(builder: (loyaltyPointController){
            return Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Text('convert_point_to_wallet_money'.tr, style: robotoMedium.copyWith(color:Get.isDarkMode?Colors.white70 :  Colors.deepPurple,fontSize: Dimensions.fontSizeLarge),),
                    Padding(
                      padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
                    ...
                    Row(children: [
                      Text('${'available_point'.tr} '
                          ,style: robotoRegular.copyWith(color:Get.isDarkMode?Colors.white70 :  Colors.deepPurple,fontSize: Dimensions.fontSizeDefault),
                        ),
                      Directionality(
