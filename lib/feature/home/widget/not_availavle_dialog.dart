        ...
        child: Column(
            ...
            children: [
              ...
              InkWell(
                ...
                child: Text("view_available_areas".tr, style: robotoMedium.copyWith( fontSize: Dimensions.fontSizeDefault, color:  Get.isDarkMode? Theme.of(context).hintColor : Colors.deepPurple, decoration : TextDecoration.underline)),
              ),
